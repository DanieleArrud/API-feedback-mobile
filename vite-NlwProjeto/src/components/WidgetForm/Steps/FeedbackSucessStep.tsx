...
export function FeedbackSucessStep({onFeedbackRestartRequested} : FeedbackSucessStepProps){
    return(
        ...
        <div className="flex flex-col items-center py-10 w-[384px]">
            ...
            className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm loading-6 hover:bg-zinc-700 transition-colors focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none"
            >
             Quero enviar outro
            </button>
        </div>
